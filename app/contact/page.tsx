        ...
        <main className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-12 -mt-10 sm:-mt-16 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-10 flex flex-col justify-between h-full border-t-4 border-[#8d3072]">
                        <div>
                            ...
                            <div className="space-y-6 md:space-y-8">
                                ...
                                <div className="flex items-start gap-4 md:gap-5 group">
                                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-rose-50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 md:w-6 md:h-6 text-[#8d3072]">
                                ...
                                <div className="flex items-start gap-4 md:gap-5 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 font-medium hover:text-rose-500 transition-colors text-sm md:text-base">
                                ...
                                <div className="flex items-start gap-4 md:gap-5 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 hover:text-rose-500 transition-colors text-sm md:text-base break-all">
                    ...
                    {/* Contact Form */}
                    <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-10 border-t-4 border-[#8d3072]">
                        ...
                        <form className="space-y-4 md:space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2 md:px-4 md:py-3 rounded-lg border border-gray-200 focus:border-[#8d3072] focus:ring-2 focus:ring-[#8d3072] outline-none transition-all text-sm md:text-base"
                                    />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-3 py-2 md:px-4 md:py-3 rounded-lg border border-gray-200 focus:border-[#8d3072] focus:ring-2 focus:ring-[#8d3072] outline-none transition-all resize-none text-sm md:text-base"
                                ></textarea>
                            </div>

                            <button
                                type="submit"
                                className="w-full py-3 md:py-4 bg-[#8d3072] text-white font-bold rounded-lg shadow-lg hover:bg-[#8d3072] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-sm md:text-base"
                            >
                                Send Message
                            </button>
                        </form>
